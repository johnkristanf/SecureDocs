<script setup>
    ...
    const uploadTypes = [
        {name: "New Document", icon: ['fas', 'file-lines']},
        {name: "New Spreadsheet", icon: ['fas', 'table']},
        {name: "New PDF", icon: ['fas', 'file-pdf']},
        {name: "New Image", icon: ['fas', 'image']},
    ]
    ...
    <Head title="Project Files" />
        ...
        <div class="w-full flex justify-end mt-12 gap-8 ">
            ...
            <div 
                ...
                :key="type.name"
                class="w-[18%] h-32 rounded-md border border-gray-200 p-3 hover:cursor-pointer hover:shadow-md hover:shadow-black transition-shadow duration-300"
            >
        ...
        <div class="flex flex-col w-full items-start mt-12">
            ...
            <div class="w-[58%] flex justify-center font-semibold text-xl">
            ...
            <div class="w-full flex justify-end mt-4 gap-8 ">
                ...
                <div 
                    ...
                    :key="size.name"
                    class="w-[18%] h-32 rounded-md border border-gray-200 p-3 font-semibold flex flex-col gap-1 items-center justify-center"
                >
                    <font-awesome-icon 
                        :icon="size.icon" 
